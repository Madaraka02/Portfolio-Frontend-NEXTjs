      ...
      <div className='w-full  p-2 flex items-center py-48 mb-10'>
        <div className='max-w-[1240px] mx-auto md:grid grid-cols-3 gap-8'>
            ...
            <p className='text-xs uppercase text-[#3d3d3d]'> </p>
                <p className='uppercase text-[#64ffda] py-4'>{project.title}</p>
            ...
            <div className='w-full h-auto m-auto flex items-center justify-center p-4 border-b-2 border-r-2 border-green-600 hover:scale-105 ease-in duration-500 shadow-xl shadow-green-400 '>
